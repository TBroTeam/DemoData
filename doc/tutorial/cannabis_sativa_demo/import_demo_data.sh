...
do 
    FEATUREID=$j
    tbro-db feature add_synonym -f $FEATUREID --synonym 'InterestingTranscript'_$j -b '[[publication/1ec511cfe178d54ff2ce82043ae958538/iimog]]' -u 'tbro' -t symbol -k 79595d0d12b7667344dd6d326fc7ba42 
done
